...
def build_llama(
    ...
    """Base builder for creating Llama3.2 models."""
    return llama3_2(
        **model_config,
...
def build_lora_llama(
    ...
    """Base builder for creating Llama3.2 models with LoRA enabled."""
...
def lora_llama3_2_1b(**kwargs) -> TransformerDecoder:
    return build_lora_llama(LLAMA3_2_1B_CONFIG, **kwargs)

def lora_llama3_2_3b(**kwargs) -> TransformerDecoder:
    return build_lora_llama(LLAMA3_2_3B_CONFIG, **kwargs)

def lora_llama3_2_1b_debug(**kwargs) -> TransformerDecoder:
    return build_lora_llama(LLAMA3_2_1B_DEBUG_CONFIG, **kwargs)

# QLoRA versions using partial
qlora_llama3_2_1b_debug = partial(lora_llama3_2_1b_debug, quantize_base=True)
